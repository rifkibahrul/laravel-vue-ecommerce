            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="border-b-2">
                        ...
                        <th class="text-left p-2 hidden lg:table-cell">Date</th>
                        <th class="text-left p-2">Status</th>
                        <th class="text-left p-2">Subtotal</th>
                        <th class="text-left p-2 hidden lg:table-cell">Items</th>
                        <th class="text-left p-2 hidden lg:table-cell">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    @if($orders->isEmpty())
                    ...
                    <tr class="border-b" data-url="{{ route('order.view', $order) }}">
                        <!-- Dekstop layar default -->
                        <td class="py-1 px-2">
                            {{ $order->id }}
                        </td>
                        <td class="py-1 px-2 whitespace-nowrap hidden lg:table-cell">{{ $order->created_at }}</td>
                        <td class="py-1 px-2">
                            <small
                        ...
                        <td class="py-1 px-2 whitespace-nowrap hidden lg:table-cell">
                            {{$order->items()->count()}} item(s)
                        </td>
                        <td class="py-1 px-2 gap-2 w-[100px] hidden lg:table-cell">
