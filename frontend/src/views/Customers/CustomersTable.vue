<template>
    <div class="bg-white p-4 rounded-md shadow animate-fade-in-down">
        <div class="flex justify-between border-b-2 pb-3">
            <div class="flex items-center">
                ...
                <span class="ml-3">Found {{ customers.total }}</span>
            </div>
            <!-- Search Bar Start -->
            <div>
                <input
        ...
        <table class="table-auto w-full">
            <thead>
                <tr>
                    ...
                    <TableHeaderCell field="name"> Action </TableHeaderCell>
                </tr>
            </thead>
            ...
            <tbody v-else>
                <tr v-for="customer of customers.data" v-bind:key="customer.id">
...
import { CUSTOMERS_PER_PAGE } from "../../constant";
