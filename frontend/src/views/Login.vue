    ...
    <GuestLayout title="Sign in to your account">
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <form class="space-y-6" action="#" method="POST">
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                  <router-link :to="{ name: 'request-password'}" class="font-semibold text-indigo-600 hover:text-indigo-500">Lupa password?</router-link>
                </div>
              </div>
              <div class="mt-2">
        ...
        <p class="mt-10 text-center text-sm/6 text-gray-500">
          Belum punya akun?
          {{ ' ' }}
          <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Daftar akun</a>
        </p>
      </div>
    </GuestLayout>
</template>
